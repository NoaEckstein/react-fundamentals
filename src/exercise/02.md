...
> React is an abstraction for using (dynamic language as) browser api for js into HTML.
> JSX is syntactic sugar React.createElement function.
> You can pass the component and props in the function's parameters.
